        ...
        <div class="article-layout">
            <main class="article-main">
                <div class="article-text">
                    ${game.description || 'لا يوجد وصف متاح لهذه اللعبة حتى الآن. ترقبوا المزيد من التفاصيل قريباً عبر قناة GameVault الرسمية.'}
                </div>
            ...
            <aside class="article-sidebar">
                <div class="side-widget big-cd">
                    ...
                    <button class="btn-notify-big" onclick="toggleNotifyDetail(${game.id})">
                        <i class="fas fa-bell"></i> أعلمني عند الإصدار
                    </button>
                </div>
                ...
                <div class="side-widget info-card">
                    ...
                    <div class="info-item">
                        ...
                        <span class="info-val">GameVault Official</span>
                    </div>
                    <div class="info-item">
...
window.toggleNotifyDetail = function(id) {
    ...
    if (idx === -1) {
        notifiedIds.push(id);
        alert('سيتم إعلامك عند توفر اللعبة!');
    } else {
        notifiedIds.splice(idx, 1);
        alert('تم إلغاء التنبيه');
    }
