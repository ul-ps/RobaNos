  ...
  banner.innerHTML = `
    <div class="upcoming-banner-content">
      ...
      <div style="display:flex; gap:15px; margin-top:20px; flex-wrap: wrap;">
        ...
        <button class="up-btn btn-trailer-banner" style="display:flex; padding: 12px 25px; border-radius:12px; border:1px solid rgba(124,58,237,0.3); background:rgba(124,58,237,0.1); color:#fff; cursor:pointer; align-items:center; gap:8px; transition:0.3s;" onmouseover="this.style.background='rgba(124,58,237,0.2)'" onmouseout="this.style.background='rgba(124,58,237,0.1)'" onclick="location.href='watch.html?id=${game.id}'">
            <i class="fas fa-play"></i> مشاهدة العرض
        </button>
        <button class="up-btn up-add-btn-featured" style="${adminActive ? 'display:flex' : 'display:none'}; padding: 12px 25px; border-radius:12px; border:1px solid rgba(255,255,255,0.1); background:rgba(255,255,255,0.05); color:#fff; cursor:pointer; align-items:center; gap:8px;" onclick="openUpModal()">
    ...
    return `
      <div class="up-card" onclick="location.href='upcoming-details.html?id=${g.id}'" style="cursor:pointer">
        ...
        <div class="up-info">
          ...
          <div class="up-actions" onclick="event.stopPropagation()">
            <button class="up-btn btn-trailer" onclick="location.href='watch.html?id=${g.id}'">
